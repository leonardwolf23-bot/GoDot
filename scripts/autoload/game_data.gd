...
const BUILDINGS := {
	...
	"holzfaeller": {
		"name": "Holzfäller",
		"beschreibung": "Schlägt Holz im Wald (+20 Holz/Tag).",
		"kategorie": "rohstoff",
		"kosten": 160,
		"groesse": Vector2i(3, 3),
		"farbe": Color(0.42, 0.28, 0.14),
		"hoehe": 22,
		"wohnraum": 0,
		"produktion": {"holz": 20.0},
		"verbrauch": {},
		"energie_bedarf": 1,
		"energie_leistung": 0,
		"effekte": {},
	...
	"steinmetz": {
		"name": "Steinmetz",
		"beschreibung": "Bricht Steine aus dem Fels (+20 Steine/Tag).",
		"kategorie": "rohstoff",
		"kosten": 180,
		"groesse": Vector2i(3, 3),
		"farbe": Color(0.52, 0.52, 0.56),
		"hoehe": 24,
		"wohnraum": 0,
		"produktion": {"steine": 20.0},
		"verbrauch": {},
		"energie_bedarf": 2,
		"energie_leistung": 0,
		"effekte": {},
